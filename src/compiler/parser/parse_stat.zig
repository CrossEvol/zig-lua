...
const EmptyStat = AstPkg.EmptyStat;
const BreakStat = AstPkg.BreakStat;
const LabelStat = AstPkg.LabelStat;
const GotoStat = AstPkg.GotoStat;
const DoStat = AstPkg.DoStat;
const WhileStat = AstPkg.WhileStat;
const RepeatStat = AstPkg.RepeatStat;
const IfStat = AstPkg.IfStat;
const Stat = AstPkg.Stat;
const ForNumStat = AstPkg.ForNumStat;
const ForInStat = AstPkg.ForInStat;
const LocalFuncDefStat = AstPkg.LocalFuncDefStat;
const LocalVarDeclStat = AstPkg.LocalVarDeclStat;
const AssignStat = AstPkg.AssignStat;
