...
const TOKEN_OP_UNM = LexerPkg.TOKEN_OP_UNM;
const TOKEN_OP_SUB = LexerPkg.TOKEN_OP_SUB;
const TOKEN_OP_BXOR = LexerPkg.TOKEN_OP_BXOR;
const TOKEN_OP_BNOT = LexerPkg.TOKEN_OP_BNOT;
const TokenKind = LexerPkg.TokenKind;
