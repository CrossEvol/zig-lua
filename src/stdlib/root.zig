...
pub const openStringLib = @import("lib_string.zig").openStringLib;
pub const openTableLib = @import("lib_table.zig").openTableLib;
pub const openUTF8Lib = @import("lib_utf8.zig").openUTF8Lib;
